...
public abstract class AutonV1 extends Robot {
    ...
    public void run(int m, double xOffset, double yOffset) throws InterruptedException {
        initialize();
        pinpointSubsystem.setPose(new Pose2d(60,72*m, Rotation2d.fromDegrees(-135*m)));
        toPoint = new DefaultGoToPointCommand(drive, pinpointSubsystem, new Pose2d(60, 72*m, new Rotation2d(0)));
        ...
        while (opModeIsActive()){
                Log.i("Motif", "BALL:" + Robot.motif[0] + " BLUE:" + Robot.motif[1] + Robot.motif[2]);
