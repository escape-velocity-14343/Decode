...
public class CreepCommand extends CommandBase {
    ...
    public void initialize() {
        toPoint.setTarget(new Pose2d(toPoint.getCurrentPose().getX(), toPoint.getCurrentPose().getY() + (0.5 * timer.seconds() * m), new Rotation2d(toPoint.getCurrentPose().getHeading())));
        timer.reset();
    }
