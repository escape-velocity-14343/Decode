...
public class MotifShoot22Command extends SequentialCommandGroup {
    public MotifShoot22Command(SpindexerSubsystem spindexer, ShooterSubsystem shooter, TransferWheelSubsystem transferWheel, TransferArmSubsystem transferArm) {
