...
public class MotifShoot23Command extends SequentialCommandGroup {
    public MotifShoot23Command(SpindexerSubsystem spindexer, ShooterSubsystem shooter, TransferWheelSubsystem transferWheel, TransferArmSubsystem transferArm) {
