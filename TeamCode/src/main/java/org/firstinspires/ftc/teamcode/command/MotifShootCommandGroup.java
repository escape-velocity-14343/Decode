...
public class MotifShootCommandGroup extends SequentialCommandGroup {
    public MotifShootCommandGroup(SpindexerSubsystem spindexer, ShooterSubsystem shooter, TransferWheelSubsystem transferWheel, TransferArmSubsystem transferArm, Localizer localizer){
...
//                new LogKittenCommand(Log.ASSERT, "motif shoot", "motif is: " + (() -> StaticValues.getMotif(0)).get() +  StaticValues.getMotif(1) + StaticValues.getMotif(2));
                ...
                new ShootCommandGroup(shooter, spindexer, transferArm, transferWheel, () -> -1, localizer, 0, ()-> StaticValues.getBallOffset()),
...
//                new WaitCommand(5000),
                ...
                //new LogKittenCommand(Log.ASSERT,"motif shoot", "shooting"),
                new ShootCommandGroup(shooter, spindexer, transferArm, transferWheel, () -> -1, localizer, 1, ()-> StaticValues.getBallOffset()),
...
//                new WaitCommand(5000),
                ...
                new ShootCommandGroup(shooter, spindexer, transferArm, transferWheel, () -> -1, localizer, 2, ()-> StaticValues.getBallOffset())
