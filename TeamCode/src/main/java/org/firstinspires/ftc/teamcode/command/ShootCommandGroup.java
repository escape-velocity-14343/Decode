...
public class ShootCommandGroup extends SequentialCommandGroup {
    ...
    public ShootCommandGroup(ShooterSubsystem shooter, SpindexerSubsystem spindexer, TransferArmSubsystem transferArm, TransferWheelSubsystem transferWheel, int ballColor, AprilTagSubsystem atag, int ballNum) {
//        telemetry.addData("hello", 1);
        addCommands(
                ...
                new ShootWithDistCommand(shooter, atag).alongWith(new SpindexOutCommand(spindexer, ballColor, ballNum)),
