...
public class ShootCommandGroup extends SequentialCommandGroup {
    ...
    public ShootCommandGroup(ShooterSubsystem shooter, SpindexerSubsystem spindexer, TransferArmSubsystem transferArm, TransferWheelSubsystem transferWheel, IntSupplier ballColor, Localizer atag, int ballNum, IntSupplier offset) {
