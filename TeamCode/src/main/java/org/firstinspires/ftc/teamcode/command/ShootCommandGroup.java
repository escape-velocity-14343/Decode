...
public class ShootCommandGroup extends SequentialCommandGroup {
    ...
    public ShootCommandGroup(ShooterSubsystem shooter, SpindexerSubsystem spindexer, TransferArmSubsystem transferArm, TransferWheelSubsystem transferWheel, IntSupplier ballColor, AprilTagSubsystem atag, IntSupplier ballNum) {
//        telemetry.addData("hello", 1);
        addCommands(
                ...
                new ShootWithDistCommand(shooter, atag).alongWith(new SpindexOutCommand(spindexer, ballColor.getAsInt(), ballNum.getAsInt())),
